...
const MyToy = ({ toy, handleDelete }) => {
    ...
    const { _id, picture, toyName, name, email, subCategory, price, rating, quantity, detail } = toy;

    return (
        < tr >
            <th className="pl-14">
                <label>
                    <button onClick={() => handleDelete(_id)} className="btn btn-circle bg-orange-800 border-none">
