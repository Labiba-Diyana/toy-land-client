        ...
        <div>
            <footer className="footer p-20 pb-14 bg-stone-300 text-base-content">
                ...
                <div className='text-base'>
                    <span className="footer-title text-lg">Address and Contacts</span>
                    <p>85 New Circular Road, Dhaka 1217</p>
                    <p>Email: <a href='https://www.google.com/' className="link link-hover">toyland@gmail.com</a></p>
                    <p>Helpline: <a onClick={handleCall} className="link link-hover">01789576230</a> ,
                        <a onClick={handleCall} className="link link-hover"> 01533486451</a> ,
                        <a onClick={handleCall} className="link link-hover"> 01743780098</a>
                    </p>
                    <p>(Available : Sun - Thu, 8:00 AM to 10:00 PM)</p>
                </div>
                <div className='text-base'>
                    <span className="footer-title text-lg">Useful Links</span>
            ...
            <footer className="footer items-center p-5 bg-green-800 text-neutral-content">
