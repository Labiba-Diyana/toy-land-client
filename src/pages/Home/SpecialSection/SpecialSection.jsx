        ...
        <div className="pb-44">
            <div className="text-center w-10/12 mx-auto pb-12">
                ...
                <div className="w-full h-full lg:h-[700px] bg-[#c8901f38] p-10 lg:p-20 rounded-xl lg:flex lg:space-x-24 shadow-xl" >
                    <img data-aos="fade-right" src='https://images.pexels.com/photos/7944016/pexels-photo-7944016.jpeg?auto=compress&cs=tinysrgb&w=1600' className="w-full lg:w-[600px] h-full shadow-2xl border-8  border-l-green-600 border-t-green-600 border-r-amber-500 border-b-amber-500" />
                    <div data-aos="fade-left" className='flex justify-center items-center h-full pt-8 lg:pt-0'>
